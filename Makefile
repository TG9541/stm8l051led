STM8EF_BOARD=STM8L051F3
STM8EF_VER=2.2.26.pre2
...
flash: target defaults
	stm8flash -c stlinkv2 -p stm8l051f3 -w out/$(STM8EF_BOARD)/$(STM8EF_BOARD).ihx

defaults:
	# stm8flash -c stlinkv2 -p stm8l051f3 -s opt -w factory_defaults.bin
